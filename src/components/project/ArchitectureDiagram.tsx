...
export function ArchitectureDiagram({ simplified = false }: ArchitectureDiagramProps) {
      ...
      {displayNodes.map((node, index) => (
        <div key={node.id} className="flex flex-col items-center w-full">
          ...
          <div
            ...
            style={node.accent === true ? { backgroundColor: 'color-mix(in srgb, var(--color-accent) 10%, transparent)', borderColor: 'color-mix(in srgb, var(--color-accent) 30%, transparent)' } : {}}
          >
            {/* Icon */}
            <div className={[
              'flex-shrink-0 mr-4',
