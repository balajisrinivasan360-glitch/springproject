    ...
    >
      <Container className="w-full py-20 md:py-0">
        <div className="flex flex-col text-center lg:text-left lg:grid lg:grid-cols-[55fr_45fr] gap-y-10 lg:gap-y-6 lg:gap-x-16 items-center lg:items-start lg:py-32">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 w-full px-4 sm:px-0">
              ...
              <motion.a
                ...
                className="group inline-flex w-full sm:w-auto justify-center items-center gap-2 px-5 py-3 lg:px-6 lg:py-3 rounded-md font-semibold text-[14px] lg:text-[15px] bg-[var(--color-accent)] text-[#1A1A1A] hover:bg-[var(--color-accent-hover)] hover:text-[#1A1A1A] transition-colors duration-200 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2"
              >
                View Projects
              ...
              <motion.a
                ...
                className="group inline-flex w-full sm:w-auto justify-center items-center gap-2 px-5 py-3 lg:px-6 lg:py-3 rounded-md font-semibold text-[14px] lg:text-[15px] border-2 border-[var(--color-border)] text-[var(--color-text-primary)] hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] hover:bg-transparent transition-colors duration-200 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2"
              >
          ...
          >
            <div className="relative w-[220px] sm:w-[260px] lg:w-full lg:max-w-[360px] aspect-square rounded-full overflow-hidden border-4 border-[var(--color-accent)] shadow-xl lg:shadow-2xl">
              <img 
                src="/profile.jpg" 
                alt={profile.name}
